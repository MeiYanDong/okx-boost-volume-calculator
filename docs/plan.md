...
S31：规则版本化与 X Layer 接入已完成。

S31 根据 OKX Boost 最新公开规则，将基础倍数改为按交易时间选择规则版本：2026-05-12 前交易保留旧规则，2026-05-12 起交易使用新规则；同时接入 X Layer，按钱包扫描时合并 BNB Chain 与 X Layer 结果。

子 plan：[S31 规则版本化与 X Layer 接入](./plans/2026-05-12-rule-versioning-xlayer.md)
