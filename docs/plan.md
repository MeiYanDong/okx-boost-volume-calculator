...
S30 继续从管理员、普通用户、滥用者、运维者和数据正确性视角审查。已让每日刷新/重扫限制真实生效并可配置，同时修复 500 钱包规模下的归档截断和 Ankr 候选交易误收录；生产部署和冒烟验证已完成。

子 plan：[S30 用量限制与规模边界审查](./plans/2026-05-10-usage-limit-scale-audit.md)
