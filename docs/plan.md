...
S17 修复服务端归档单 key 导致的多用户数据覆盖，以及服务端旧归档覆盖本地新增钱包的问题。当前已完成本地实现，待构建验证和生产部署。

子 plan：[S17 归档数据空间隔离](./plans/2026-05-10-archive-workspaces.md)
...
| S17 归档数据空间隔离 | 进行中 | [子 plan](./plans/2026-05-10-archive-workspaces.md) | 用数据空间隔离用户归档，避免新增地址被旧归档覆盖 |
